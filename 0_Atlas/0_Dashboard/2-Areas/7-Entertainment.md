...
> >         };
> >         const values = [
> >             dv.pages('#2area/7entertain AND !"zData"').length,
...
> > > FROM #2area/7entertain AND !"zData"
...
> > > WHERE contains(string(area2), "7_Entertainment") OR contains(string(area2), "7entertain") OR contains(string(archtype), "#2area/7entertain") OR contains(string(file.outlinks), "7_Entertainment")
