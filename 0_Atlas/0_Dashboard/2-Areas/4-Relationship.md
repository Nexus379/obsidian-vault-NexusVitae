...
> >             return hay.includes('#2area/4relationship') || hay.includes('2area/2relationship') || hay.includes('2_areas/2_relationship') || hay.includes('2_relationship') || hay.includes('2relationship');
> >         };
> >         const values = [
> >             dv.pages('#2area/4relationship AND !"zData" AND -"yArchive"').where(p => p.inbox !== true).length,
...
> > > WHERE (contains(string(area2), "2_Relationship") OR contains(string(area2), "2relationship")) AND inbox != true
...
> > > WHERE (contains(string(area2), "2_Relationship") OR contains(string(area2), "2relationship") OR contains(string(archtype), "#2area/4relationship") OR contains(string(file.outlinks), "2_Relationship")) AND inbox != true
