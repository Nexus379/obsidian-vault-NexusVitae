...
> >             return hay.includes('#2area/3drive') || hay.includes('2area/4organize') || hay.includes('2_areas/4_organize') || hay.includes('4_organize') || hay.includes('4organize');
> >         };
> >         const values = [
> >             dv.pages('#2area/3drive AND !"zData" AND -"yArchive"').where(p => p.inbox !== true).length,
...
> > > FROM #2area/3drive AND !"zData" AND -"yArchive"
> > > WHERE inbox != true
...
> > > WHERE (contains(string(area2), "4_Organize") OR contains(string(area2), "4organize") OR contains(string(archtype), "#2area/3drive") OR contains(string(file.outlinks), "4_Organize")) AND inbox != true
