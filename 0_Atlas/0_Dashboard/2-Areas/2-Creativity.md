...
> >             return hay.includes('#2area/2creativity') || hay.includes('2area/5creativity') || hay.includes('2_areas/5_creativity') || hay.includes('5_creativity') || hay.includes('5creativity');
> >         };
> >         const values = [
> >             dv.pages('#2area/2creativity AND !"zData" AND -"yArchive"').where(p => p.inbox !== true).length,
...
> > > WHERE (contains(string(area2), "5_Creativity") OR contains(string(area2), "5creativity")) AND inbox != true
...
> > > WHERE (contains(string(area2), "5_Creativity") OR contains(string(area2), "5creativity") OR contains(string(archtype), "#2area/2creativity") OR contains(string(file.outlinks), "5_Creativity")) AND inbox != true
