...
> >         };
> >         const values = [
> >             dv.pages('#2area/4organize AND !"zData"').length,
...
> > > FROM #2area/4organize AND !"zData"
...
> > > WHERE contains(string(area2), "4_Organize") OR contains(string(area2), "4organize") OR contains(string(archtype), "#2area/4organize") OR contains(string(file.outlinks), "4_Organize")
