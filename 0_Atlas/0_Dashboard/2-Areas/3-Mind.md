...
> >         };
> >         const values = [
> >             dv.pages('#2area/3mind AND !"zData"').length,
...
> > > WHERE contains(string(area2), "3_Mind") OR contains(string(area2), "3mind") OR contains(string(archtype), "#2area/3mind") OR contains(string(file.outlinks), "3_Mind")
