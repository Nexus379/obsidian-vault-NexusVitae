...
> >             return hay.includes('#2area/3drive') || hay.includes('2area/6activity') || hay.includes('2_areas/6_activity') || hay.includes('6_activity') || hay.includes('6activity');
> >         };
> >         const values = [
...
> > > WHERE (contains(string(area2), "6_Activity") OR contains(string(area2), "6activity") OR contains(string(archtype), "#2area/3drive") OR contains(string(file.outlinks), "6_Activity")) AND inbox != true
