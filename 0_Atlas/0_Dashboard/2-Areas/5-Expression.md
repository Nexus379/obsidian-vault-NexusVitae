...
> >         const _c = _d.areaCounts('5expression');
...
> > WHERE contains(string(area2), "5expression") AND status != "done" AND status != "canceled" AND inbox != true
...
> > > WHERE (contains(string(area2), "5_Expression") OR contains(string(area2), "5expression")) AND inbox != true
...
> > > WHERE (contains(string(area2), "5_Expression") OR contains(string(area2), "5expression") OR contains(string(archtype), "#2area/5expression") OR contains(string(file.outlinks), "5_Expression")) AND inbox != true
