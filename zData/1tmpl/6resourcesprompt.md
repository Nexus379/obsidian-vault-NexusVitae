...
const resources = [
    ...
    { label: "🗞️ Article", val: "sourcearticle", folder: "Articles" },
    ...
    { label: "🕹️ Game", val: "sourcegame", folder: "Games" },
    { label: "🗺️ Guide", val: "sourceguide", folder: "Guides" },
    { label: "🖼️ Museum", val: "sourcemuseum", folder: "Museums" },
    ...
    { label: "🎞️ Serie", val: "sourceserie", folder: "Series" },
    ...
    { label: "🏋️ Fitness Gear", val: "sourceentities_fitness", folder: "_Entities/Fitness" },
    ...
    { label: "⚔️ LARP Gear", val: "sourceentities_larp", folder: "_Entities/LARP" }
];
