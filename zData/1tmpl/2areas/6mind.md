...
// 🔱 THIRD-EYE PROMPT (Insight & Vision)
...
let displayTitle = title.replace(/^\d+[\d.a-z]*\s+/i, "").replace(/^(6mind-|a-|2area-)/i, "").trim();
...
> [!abstract] Knowledge & Vision (GTD Horizon 2 · Areas of Focus)
...
> [!multi-column]
>
> > [!brain|wide-1] Third-Eye-Chakra: Insight & Vision
> > **Mantra:** <%- balanceFocus %>
> > 
