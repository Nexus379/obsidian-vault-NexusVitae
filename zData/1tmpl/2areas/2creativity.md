...
const area = tp.variables.currentArea || tp.variables.area || "#2area/2creativity";
...
> [!palette] Creativity & Play (GTD Horizon 2 · Areas of Focus)
...
> [!multi-column]
>
> > [!abstract|wide-1] Sacral-Chakra: Creative Flow
> > **Focus:** <%- balanceFocus %>
> > 
