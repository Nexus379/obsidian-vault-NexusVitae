...
// 🔱 4. CLEANING
let displayTitle = (tp.variables && tp.variables.displayTitle) ? tp.variables.displayTitle : title.replace(/^\d+[\d.a-z]*\s+/i, "").replace(/^(7procook-|p-|3project-)/i, "").trim();
...
> [!info]  Focus: Culinary Execution (Horizon 1)
> > [!multi-column]
> > > [!blank|wide-5]
