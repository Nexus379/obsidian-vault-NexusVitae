...
const icon = "🏃🏽"; // Fixed anchor for Pro-Go
...
// 🔱 5. CLEANING
let displayTitle = (tp.variables && tp.variables.displayTitle) ? tp.variables.displayTitle : title.replace(/^\d+[\d.a-z]*\s+/i, "").replace(/^(2progo-|p-|3project-)/i, "").trim();
