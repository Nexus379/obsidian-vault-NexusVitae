...
// 🔱 4. CLEANING
let displayTitle = (tp.variables && tp.variables.displayTitle) ? tp.variables.displayTitle : title.replace(/^\d+[\d.a-z]*\s+/i, "").replace(/^(8procraft-|p-|3project-)/i, "").trim();
...
> [!info] Focus: Physical Creation (Horizon 1)
> > [!multi-column]
> > > [!blank|wide-5]
