...
const config = {
    ...
    prolog: { suffix: "prjlog", folder: "0_Calendar/4_Projectlogs", template: "zData/1temp/0cal/projectlog", icon: "🧩", color: "#ffb86c" },
    proto: { suffix: "prtcl", folder: "0_Calendar/5_Protocols", template: "zData/1temp/0cal/protocol", icon: "📜", color: "#8be9fd" },
    rev: { suffix: "rev", folder: "0_Calendar/6_Reviews", template: "zData/1temp/0cal/revweekly", icon: "🛰️", color: "#50fa7b" }
};
