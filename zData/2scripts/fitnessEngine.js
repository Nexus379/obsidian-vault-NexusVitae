function fitnessEngine() {
    const EXERCISES = {
        ...
        soccer: { label: "Soccer / Football", icon: "⚽", muscles_region: ["cardio", "lower", "core"], persona: "player", baseTime: 45, equipment: ["soccer_ball", "cleats"], muscles_target: ["quads", "hamstrings", "calves", "core"], desc: "High-intensity sprints and footwork." },
        american_football: { label: "American Football", icon: "🏈", muscles_region: ["cardio", "lower", "upper", "core"], persona: "warrior", baseTime: 45, equipment: ["football", "cleats", "pads"], muscles_target: ["quads", "glutes", "shoulders", "core"], desc: "Explosive power, sprinting, and high-impact contact." },
        rugby: { label: "Rugby", icon: "🏉", muscles_region: ["cardio", "lower", "upper", "core"], persona: "warrior", baseTime: 45, equipment: ["rugby_ball", "cleats"], muscles_target: ["quads", "glutes", "shoulders", "core"], desc: "Continuous running, tackling, and raw physical strength." },
        baseball: { label: "Baseball / Softball", icon: "⚾", muscles_region: ["upper", "lower", "core"], persona: "player", baseTime: 60, equipment: ["baseball", "bat", "glove"], muscles_target: ["obliques", "shoulders", "forearms", "glutes"], desc: "Rotational power, sprinting, and hand-eye coordination." },
        basketball: { label: "Basketball", icon: "🏀", muscles_region: ["cardio", "lower", "upper", "core"], persona: "player", baseTime: 30, equipment: ["basketball", "court"], muscles_target: ["calves", "quads", "shoulders", "triceps"], desc: "Jumping, sprinting, and upper body coordination." },
        volleyball: { label: "Volleyball", icon: "🏐", muscles_region: ["cardio", "lower", "upper", "core"], persona: "player", baseTime: 30, equipment: ["volleyball", "net"], muscles_target: ["calves", "quads", "shoulders", "core"], desc: "Explosive jumps, diving, and hand-eye coordination." },
        handball: { label: "Handball", icon: "🤾", muscles_region: ["cardio", "upper", "lower", "core"], persona: "player", baseTime: 30, equipment: ["handball", "court"], muscles_target: ["shoulders", "triceps", "core", "calves"], desc: "Fast-paced throwing, sprinting, and physical contact." },
        ice_hockey: { label: "Ice Hockey", icon: "🏒", muscles_region: ["cardio", "lower", "core"], persona: "warrior", baseTime: 30, equipment: ["hockey_stick", "puck", "skates"], muscles_target: ["quads", "glutes", "core", "forearms"], desc: "High-speed skating, balance, and upper body control." },
        field_hockey: { label: "Field Hockey", icon: "🏑", muscles_region: ["cardio", "lower", "core"], persona: "player", baseTime: 45, equipment: ["hockey_stick", "ball", "cleats"], muscles_target: ["quads", "hamstrings", "lower_back", "forearms"], desc: "Agility, endurance, and precise stick-handling." },
        ultimate_frisbee: { label: "Ultimate Frisbee", icon: "🥏", muscles_region: ["cardio", "lower", "core"], persona: "player", baseTime: 45, equipment: ["frisbee", "cleats"], muscles_target: ["calves", "quads", "shoulders", "core"], desc: "Constant sprinting, jumping, and precise throwing." },
        tennis: { label: "Tennis", icon: "🎾", muscles_region: ["cardio", "lower", "upper", "core"], persona: "player", baseTime: 45, equipment: ["tennis_racket", "tennis_ball", "court"], muscles_target: ["obliques", "shoulders", "forearms", "calves"], desc: "High-speed sprints, rotational core strength, and swings." },
        badminton: { label: "Badminton", icon: "🏸", muscles_region: ["cardio", "lower", "upper"], persona: "player", baseTime: 30, equipment: ["badminton_racket", "shuttlecock", "net"], muscles_target: ["calves", "shoulders", "triceps", "glutes"], desc: "Agility, deep lunges, and overhead strikes." },
        squash: { label: "Squash", icon: "🏸", muscles_region: ["cardio", "lower", "upper", "core"], persona: "player", baseTime: 30, equipment: ["squash_racket", "squash_ball", "court"], muscles_target: ["glutes", "quads", "shoulders", "forearms"], desc: "Intense bursts of speed, lunging, and reflexes." },
        padel: { label: "Padel / Pickleball", icon: "🏓", muscles_region: ["cardio", "lower", "upper"], persona: "player", baseTime: 45, equipment: ["paddle", "ball", "court"], muscles_target: ["calves", "shoulders", "forearms", "obliques"], desc: "Dynamic lateral movements and strategic shot placement." },
        table_tennis: { label: "Table Tennis", icon: "🏓", muscles_region: ["cardio", "upper", "core"], persona: "player", baseTime: 20, equipment: ["paddle", "table_tennis_ball", "table"], muscles_target: ["forearms", "shoulders", "calves", "obliques"], desc: "Lightning-fast reflexes and lateral movement." },
        golf: { label: "Golf", icon: "⛳", muscles_region: ["core", "lower"], persona: "traveler", baseTime: 120, equipment: ["golf_clubs", "golf_ball"], muscles_target: ["obliques", "core", "shoulders", "glutes"], desc: "Rotational core strength, walking, and absolute focus." },
