...
> > **Status:** Data-sync active with `0_Calendar/7_Plan/` (Weekly Meal Plans) & [[0_Atlas/0_Dashboard/6-Resources/Recipes | Recipes Database]].
>
> > [!todo] ➕ Quick Actions
...
> [!info] 🛒 Automatic shopping list
> The list builds itself when you create your Daily Log in the morning and that day's timeblocking has `groceries` in it.
> It works out what you need from the days until your next shop (the lookahead) and saves the finished list in `0_Calendar/4_Projectlogs/Utilities`.
> 
> *Or generate one here whenever you like:*
