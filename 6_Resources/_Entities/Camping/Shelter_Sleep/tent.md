...
| :------------- | :------- | --- |
| **Type** | `INPUT[suggester(option(tent, ⛺ Tent), option(sleeping_bag, 🛏️ Sleeping Bag), option(sleeping_pad, 🛌 Sleeping Pad), option(cooking, 🍳 Cooking), option(water_filter, 💧 Water Filter), option(backpack, 🎒 Backpack), option(tool, 🔪 Tool)):camping_type]` |     |
