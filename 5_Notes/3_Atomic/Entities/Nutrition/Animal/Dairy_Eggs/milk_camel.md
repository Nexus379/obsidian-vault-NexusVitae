...
aliases:
  - "Camel Milk"
  - "Kamelmilch"
  - "Lactis camelnum (Camelus dromedarius)"
  - "Lait de chamelle"
  - "Leche de camella"
  - "Верблюжье молоко"
  - "ラクダ乳"
...
season: 
  - "all_year"
latin: "Lactis camelnum (Camelus dromedarius)"
es: "Leche de camella"
ar: "حليب ناقة"
unit_type: "piece"
icon: "🐪"
...
hi: "ऊंटनी का दूध"
unit_price: 12.00
benefit: "No Beta-Lactoglobulin (Allergy-friendly)"
props: 
  - "Three times higher Vitamin C than cow milk"
  - "Contains insulin-like proteins"
  - "Staple in desert cultures for hydration and nutrients"
orient_market: 12.00
label: "Camel Milk"
ru: "Верблюжье молоко"
de: "Kamelmilch"--
