...
aliases:
  ...
  - "Marinated Spareribs"
  - "Spareribs (Mariniert)"
  - "Spareribs / Schälrippchen (Mariniert & Vorgegart)"
  - "Sus scrofa (Costae marinatae coctae)"
  - "Travers de porc marinés"
  - "Маринованные ребрышки"
  - "أضلاع متبلة"
  - "دنده طعم‌دار شده"
  - "मैरिनेटेड स्पेयररिब्स"
  - "味付けスペアリブ"
  - "秘制烤排骨"
priority: 
subject: "Nutrition"
...
# preparation: "Sous-vide / Pre-cooked"
locations: 
  - "lidl"
  - "kaufland"
  - "aldi"
...
de: "Spareribs (Mariniert)"
fiber_g: 0.5
es: "Costillas marinadas"
aldi: 10.00
ar: "أضلاع متبلة"
sodium_mg: 1100.0
icon: "🍖"
...
fat_total_g: 19.0
kaufland: 10.00
fr: "Travers de porc marinés"
water_g: 55.0
sci: 
  - "#sci/FoodScience"
  - "#sci/Culinary"
carbs_total_g: 4.0
latin: "Sus scrofa (Costae marinatae coctae)"
en: "Marinated Spareribs"
hi: "मैरिनेटेड स्पेयररिब्स"
unit_price: 10.00
props: 
  - "Meist industriell vorgegart (sous-vide) und in dicker BBQ-Marinade eingeschweißt"
  - "Garantieren 'Fall-off-the-bone'-Zartheit ohne stundenlanges Smoken"
  - "Enthalten durch die süße Barbecue-Glasur deutlich mehr Zucker als pure Steaks"
label: "Spareribs / Schälrippchen (Mariniert & Vorgegart)"
ru: "Маринованные ребрышки"
lidl: 10.00
unit_type: "piece"--
arch:
  - "#5note"
...
# 🥗  N2026063012482873   Spareribs / Schälrippchen (Mariniert & Vorgegart)
