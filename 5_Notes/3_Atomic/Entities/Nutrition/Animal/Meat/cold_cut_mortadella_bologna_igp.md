...
aliases:
  ...
  - "Mortadella Bologna IGP (Original Italienisch)"
  - "Mortadelle de Bologne"
  - "Sus scrofa (Farcimen Bononiense)"
  - "Мортаделла (Болонья)"
  - "モルタデッラ (ボローニャ)"
  - "مرتديلا بولونيا"
  - "مورتادلا بولونیا"
...
season: 
  - "all_year"
sugar_g: 0.0
de: "Mortadella Bologna IGP"
fiber_g: 0.0
es: "Mortadela de Bolonia"
ar: "مرتديلا بولونيا"
sodium_mg: 900.0
icon: "🥩"
ja: "モルタデッラ (ボローニャ)"
...
kcal: 288
fat_total_g: 25.0
texture: "Silky with solid fat cubes (lardons)"
fr: "Mortadelle de Bologne"
water_g: 52.0
inclusion: "Pistachios & Black Pepper"
sci: 
  - "#sci/Culinary"
  - "#sci/FoodScience"
carbs_total_g: 0.0
edeka: 5.00
latin: "Sus scrofa (Farcimen Bononiense)"
delicatessen: 5.00
en: "Mortadella Bologna"
hi: "मोर्टाडेला बोलोग्ना"
unit_price: 5.00
props: 
  - "Authentic Italian cold cut with visible cubes of throat fat (lardons)"
  - "Protected Geographical Indication (IGP) ensures high quality standards"
  - "Silky texture achieved by extensive emulsification (traditionally in a mortaio)"
label: "Mortadella Bologna IGP (Original Italienisch)"
origin: "Bologna, Italy"
ru: "Мортаделла (Болонья)"
rewe: 5.00
unit_type: "piece"--
arch:
  - "#5note"
...
# 🥗  N2026063012482796   Mortadella Bologna IGP (Original Italienisch)
