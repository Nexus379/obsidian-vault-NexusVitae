...
note5:
nextstudy:
LID: "N2026063012483781"
parent: ""
tags:
  - "#entity/ingredient"
aliases:
  - "Chili Cheese Nuggets (Snack)"
  - "Chili Cheese Nuggets Snack"
  - "Globuli casei kauflandii"
  - "K-Classic Chili Cheese Nuggets (Snack)"
  - "Nuggets chili-fromage"
  - "Nuggets de queso y chili"
  - "Чили-чиз наггетсы (закуска)"
  - "チリチーズナゲットスナック"
  - "ناجتس الجبن بالفلفل (سناك)"
  - "ناگت پنیر چیلی (اسنک)"
  - "मिर्च पनीर नगेट्स स्नैक"
  - "辣椒芝士味干脆块"
priority: 
subject: "Nutrition"
persona: "alchemist"
...
# locations: 
  - "kaufland"
fa: "ناگت پنیر چیلی (اسنک)"
protein_g: 6.5
zh: "辣椒芝士味干脆块"
sugar_g: 3.5
flavor: "Spicy Cheese focus"
de: "Chili Cheese Nuggets (Snack)"
es: "Nuggets de queso y chili"
ar: "ناجتس الجبن بالفلفل (سناك)"
unit_type: "piece"
icon: "🌶️"
ja: "チリチーズナゲットスナック"
vegan: false
...
fat_total_g: 30.0
kaufland: 1.50
texture: "Crunchy ball"
fr: "Nuggets chili-fromage"
water_g: 2.0
sci: 
  - "#sci/FoodScience"
carbs_total_g: 54.0
...
# 🥗  N2026063012483781   K-Classic Chili Cheese Nuggets (Snack)
