...
# aroma: "Very Strong / Spicy"
specialty_store: 15.00
locations: 
  - "denns"
  - "reformhaus"
  - "specialty_store"
...
unit_price: 15.00
props: 
  - "Technologische Besonderheit: Er ist thixotrop (gelartig im Glas, wird unter Bewegung kurz flüssig)"
  - "Sehr kräftiges, fast herbes Aroma"
  - "Einer der teuersten deutschen Honige aufgrund der aufwendigen Ernte (Stippen statt Schleudern)"
denns: 15.00
label: "Heidehonig (Gelierend)"
ru: "Вересковый мёд"--
arch:
  - "#5note"
archtype:
...
# 🥗  N2026063012483458   Heidehonig (Gelierend)
