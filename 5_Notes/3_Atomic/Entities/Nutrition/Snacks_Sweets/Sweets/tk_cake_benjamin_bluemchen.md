...
aliases:
  ...
  - "Bolo benjamini blumchenis"
  - "Gâteau éléphant"
  - "Tarta de elefante"
  - "Торт Бенджамин Блюмхен"
  - "ベンジャミン・ケーキ"
  - "كعكة الفيل بنجامين"
  - "کیک فیل بنجامین"
  - "बेंजामिन एलीफेंट केक"
  - "本杰明大象蛋糕"
priority: 
subject: "Nutrition"
persona: "alchemist"
...
fa: "کیک فیل بنجامین"
protein_g: 3.5
layers: "Strawberry cream & Chocolate sponge"
zh: "本杰明大象蛋糕"
latin: "Bolo benjamini blumchenis"
es: "Tarta de elefante"
ar: "كعكة الفيل بنجامين"
unit_type: "piece"
icon: "🐘"
ja: "ベンジャミン・ケーキ"
everywhere: 10.00
...
props: 
  ...
  - "Ikonisches Design mit hohem Nostalgie-Faktor"
label: "Benjamin Blümchen Torte (Coppenrath & Wiese)"
...
# 🥗  N2026063012483941   Benjamin Blümchen Torte (Coppenrath & Wiese)
