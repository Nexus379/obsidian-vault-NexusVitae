...
aliases:
  - "Haribo Goldbären"
  - "Haribo Goldbears"
  - "Ositos de Oro Haribo"
  - "Ours d'Or Haribo"
  - "Ursuli gelati (Haribo)"
  - "Золотые мишки Харибо"
  - "ハリボー ゴールドベア"
  - "هاريبو الدببة الذهبية"
  - "هاریبو خرس طلایی"
  - "हारिबो गोल्डबियर्स"
  - "哈瑞宝金熊"
priority: 
...
de: "Haribo Goldbären"
fiber_g: 0.1
es: "Ositos de Oro Haribo"
ar: "هاريبو الدببة الذهبية"
unit_type: "piece"
icon: "🐻"
glazing: "Beeswax / Carnauba wax"
ja: "ハリボー ゴールドベア"
everywhere: 1.50
vegan: false
kcal: 343
...
props: 
  ...
  - "Farben werden ausschließlich aus Frucht- und Pflanzenkonzentraten gewonnen"
...
# 🥗  N2026063012483670   Haribo Goldbären
