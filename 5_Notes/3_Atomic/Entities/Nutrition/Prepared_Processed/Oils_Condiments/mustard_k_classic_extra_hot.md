...
note5:
nextstudy:
LID: "N2026063012483576"
parent: ""
tags:
  - "#entity/ingredient"
aliases:
  - "Brassica nigra (Kaufland)"
  - "K-Classic Hot Mustard"
  - "K-Classic Senf (Scharf)"
  - "K-Classic Senf (Scharf/Extra)"
  - "K-Classic 特辣芥末"
  - "K-Classic 辛口マスタード"
  - "Mostaza picante K-Classic"
  - "Moutarde forte K-Classic"
  - "Горчица острая K-Classic"
  - "خردل تند کا-کلاسیک"
  - "خردل حار ك-كلاسيك"
  - "के-क्लासिक तीखी सरसों"
priority: 
subject: "Nutrition"
persona: "alchemist"
status: 1active
...
# locations: 
  - "kaufland"
fa: "خردل تند کا-کلاسیک"
protein_g: 7.0
zh: "K-Classic 特辣芥末"
sugar_g: 2.0
de: "K-Classic Senf (Scharf)"
fiber_g: 3.5
es: "Mostaza picante K-Classic"
heat_level: "High (Black Mustard source)"
unit_type: "piece"
icon: "🔥"
ja: "K-Classic 辛口マスタード"
vegan: true
kcal: 115
fat_total_g: 7.5
kaufland: 1.00
fr: "Moutarde forte K-Classic"
water_g: 68.0
sci: 
  - "#sci/Phytochemistry"
carbs_total_g: 4.5
...
props: 
  ...
  - "Classic yellow tube or jar for high-volume consumption"
  - "Aggressive sinus-clearing effect"
label: "K-Classic Senf (Scharf/Extra)"
...
# 🥗  N2026063012483576   K-Classic Senf (Scharf/Extra)
