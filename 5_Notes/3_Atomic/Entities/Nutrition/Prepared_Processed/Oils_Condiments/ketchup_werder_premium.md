...
aliases:
  - "Ketchup Werder"
  - "Kétchup Werder"
  - "Solanum conditum (Werder)"
  - "Werder Tomaten Ketchup"
  - "Werder Tomaten Ketchup (Klassik)"
  - "Werder Tomato Ketchup"
  - "Werder 番茄酱"
  - "Кетчуп Вердер"
  - "ヴェルダー ケチャップ"
  - "كاتشب فيردر"
...
carbs_total_g: 25.5
edeka: 3.00
latin: "Solanum conditum (Werder)"
en: "Werder Tomato Ketchup"
hi: "वरदेर केचप"
unit_price: 3.00
props: 
  - "The cult ketchup of East Germany"
  - "Known for a much milder acidity and a more pronounced natural tomato flavor than Heinz"
  - "Uses a specific spice blend that highlights fruitiness over tanginess"
label: "Werder Tomaten Ketchup (Klassik)"
origin: "Brandenburg, Germany"
ru: "Кетчуп Вердер"
tomato_intensity: "Fruitier / Less Vinegar"
brand: "Werder"
rewe: 3.00--
arch:
  - "#5note"
...
# 🥗  N2026063012483584   Werder Tomaten Ketchup (Klassik)
