...
aliases:
  ...
  - "Mostaza extra fuerte"
  - "Moutarde extra forte"
  - "Sinapis nigra (Loewen)"
  - "Острая горчица (Loewensenf)"
  - "خردل بسیار تند"
  - "خردل حار جداً"
  - "अत्यधिक तीखी सरसों"
  - "激辛マスタード"
...
de: "Löwensenf Extra"
fiber_g: 4.5
es: "Mostaza extra fuerte"
heat_level: "Extremely High (Nasal heat)"
sodium_mg: 950.0
icon: "🔥"
ja: "激辛マスタード"
everywhere: 2.00
...
props: 
  ...
  - "Pure heat based on brown/black mustard seeds"
  - "Naturally preserved by mustard oils, no additives needed"
process: "Dijon method (No vinegar focus)"
label: "Löwensenf Extra (Scharf)"
...
# 🥗  N2026063012483558   Löwensenf Extra (Scharf)
