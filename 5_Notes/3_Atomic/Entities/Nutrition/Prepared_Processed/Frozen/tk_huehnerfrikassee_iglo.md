...
aliases:
  ...
  - "Fricasé de pollo"
  - "Fricassée de poulet"
  - "Fricassee galli iglonis"
  - "Hühnerfrikassee"
  - "Iglo Hühnerfrikassee (mit Reis)"
  - "Куриное фрикасе"
  - "チキン・フリカッセ"
  - "فريكاسيه الدجاج"
  - "فریکاسه مرغ"
...
sci: 
  - "#sci/FoodScience"
components: "Chicken, Peas, Carrots, Rice, Cream Sauce"
en: "Chicken Fricassee"
hi: "चिकन फ्रिकैसी"
unit_price: 4.00
props: 
  - "Deutscher Hausmannskost-Klassiker technologisch konserviert"
  - "Sehr mild gewürzt, ideal für empfindliche Mägen"
  - "Gute Verteilung von Fleisch und Gemüse"
label: "Iglo Hühnerfrikassee (mit Reis)"
ru: "Куриное фрикасе"
de: "Hühnerfrikassee"
brand: "Iglo"--
arch:
...
# 🥗  N2026063012483914   Iglo Hühnerfrikassee (mit Reis)
