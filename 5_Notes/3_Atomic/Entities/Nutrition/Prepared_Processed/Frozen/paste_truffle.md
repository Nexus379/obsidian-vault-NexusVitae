...
aliases:
  - "Pâte de truffe"
  - "Salsa de trufa"
  - "Trüffelcreme (Tartufata)"
  - "Truffle Paste"
  - "Truffle Paste / Tartufata"
  - "Tuber blend with mushrooms"
  - "Трюфельная паста"
  - "トリュフペースト"
  - "سس ترافل"
  - "معجون الكمأة"
...
# aroma: "Intense earthy/garlicky"
composition: "Mostly button mushrooms with truffle flavor/fragments"
locations: 
  - "gourmet_market"
  - "rewe"
fa: "سس ترافل"
...
sci: 
  ...
  - "#sci/Culinary"
carbs_total_g: 4.0
latin: "Tuber blend with mushrooms"
...
props: 
  ...
  - "Used to finish pasta dishes or as a crostini spread"
...
# 🥗  N2026063012483447   Truffle Paste / Tartufata
