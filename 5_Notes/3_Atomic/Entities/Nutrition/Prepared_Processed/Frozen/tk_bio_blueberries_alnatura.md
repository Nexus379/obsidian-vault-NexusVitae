...
note5:
nextstudy:
LID: "N2026063012483748"
parent: ""
tags:
  - "#entity/ingredient"
aliases:
  - "Alnatura Bio Heidelbeeren (TK)"
  - "Arándanos bio congelados"
  - "Bio Heidelbeeren (TK)"
  - "Myrtilles bio surgelées"
  - "Organic Blueberries (Frozen)"
  - "Vaccinium myrtillus (Frozen)"
  - "Био черника замороженная"
  - "بلوبری بیو منجمد"
  - "توت أزرق عضوي مجمد"
  - "जैविक फ्रोजन ब्लूबेरी"
  - "有机冷冻蓝莓"
  - "有機冷凍ブルーベリー"
priority: 
subject: "Nutrition"
...
zh: "有机冷冻蓝莓"
sugar_g: 7.3
de: "Bio Heidelbeeren (TK)"
fiber_g: 4.8
es: "Arándanos bio congelados"
ar: "توت أزرق عضوي مجمد"
unit_type: "piece"
icon: "🫐"
ja: "有機冷凍ブルーベリー"
vegan: true
...
props: 
  ...
  - "Extrem hoher Anteil an sekundären Pflanzenstoffen"
  - "Perfekt für Smoothies und Porridge ohne Wasserverlust"
process: "IQF (Schockgefrostet)"
label: "Alnatura Bio Heidelbeeren (TK)"
origin: "EU-Agriculture (Organic)"
...
# 🥗  N2026063012483748   Alnatura Bio Heidelbeeren (TK)
