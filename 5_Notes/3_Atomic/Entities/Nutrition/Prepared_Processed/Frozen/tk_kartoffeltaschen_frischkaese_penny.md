...
aliases:
  ...
  - "Kartoffeltaschen (Penny)"
  - "Penny Kartoffeltaschen (Frischkäse & Kräuter)"
  - "Sachets de pommes de terre fourrés"
  - "Solanum frictum impletum"
  - "Картофельные кармашки с начинкой"
  - "ポテトポケット"
  - "جیب‌های سیب‌زمینی پر شده"
  - "جيوب البطاطس المحشوة"
  - "भरे हुए आलू पॉकेट"
  - "夹心土豆饼"
priority: 
subject: "Nutrition"
...
# locations: 
  - "penny"
fa: "جیب‌های سیب‌زمینی پر شده"
protein_g: 3.0
zh: "夹心土豆饼"
latin: "Solanum frictum impletum"
es: "Bolsitas de patata rellenas"
ar: "جيوب البطاطس المحشوة"
label: "Penny Kartoffeltaschen (Frischkäse & Kräuter)"
icon: "📁"
ja: "ポテトポケット"
vegan: false
kcal: 195
fat_total_g: 8.5
texture: "Hash-brown style crust"
fr: "Sachets de pommes de terre fourrés"
water_g: 60.0
sci: 
  - "#sci/FoodScience"
  - "#sci/Microbiology"
...
props: 
  ...
  - "Kombiniert den Crunch von Röstis mit cremiger Füllung"
filling_ratio: "20% Cream Cheese"
ru: "Картофельные кармашки с начинкой"
de: "Kartoffeltaschen (Penny)"
brand: "Penny"
penny: 2.00
unit_type: "piece"--
arch:
...
# 🥗  N2026063012483829   Penny Kartoffeltaschen (Frischkäse & Kräuter)
