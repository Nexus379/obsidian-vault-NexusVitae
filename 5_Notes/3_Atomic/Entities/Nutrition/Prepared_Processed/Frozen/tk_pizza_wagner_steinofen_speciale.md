...
aliases:
  ...
  - "Wagner Steinofen Speciale"
  - "Wagner Stone Oven Speciale"
  - "Вагнер Спечиале"
  - "ワーグナー・スペシャル"
  - "واغنر ستينوفن سبيشالي"
  - "واگنر اشپزیاله"
  - "वैगनर स्टोन ओवन स्पेशल"
  - "瓦格纳石烤特制比萨"
priority: 
subject: "Nutrition"
persona: "alchemist"
...
protein_g: 9.8
zh: "瓦格纳石烤特制比萨"
latin: "Pizza petra-furnus"
es: "Wagner Especial"
ar: "واغنر ستينوفن سبيشالي"
label: "Wagner Steinofen (Speciale)"
icon: "🔥"
ja: "ワーグナー・スペシャル"
everywhere: 4.00
vegan: false
...
base: "Classic stone oven crust"
topping_variety: "Salami, Ham, Mushrooms"
ru: "Вагнер Спечиале"
...
# 🥗  N2026063012483825   Wagner Steinofen (Speciale)
