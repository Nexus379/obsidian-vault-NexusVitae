...
aliases:
  - "Curly Fries"
  - "Frites spirales"
  - "Locken-Pommes / Curly Fries"
  - "McCain Curly Fries (Spicy)"
  - "Patatas espirales"
  - "Solanum frictum spiralis"
  - "Картофель фри спиральки"
  - "カーリーフライ"
  - "بطاطس لولبية"
  - "سیب‌زمینی فنری"
  - "कर्ली फ्राइज़"
...
protein_g: 3.0
zh: "卷卷薯条"
latin: "Solanum frictum spiralis"
es: "Patatas espirales"
ar: "بطاطس لولبية"
unit_type: "piece"
icon: "🌀"
ja: "カーリーフライ"
...
props: 
  ...
  - "Extrem knusprig durch den hohen Anteil an gewürzter Panade"
  - "Hält die Hitze deutlich länger als normale Pommes"
label: "McCain Curly Fries (Spicy)"
ru: "Картофель фри спиральки"
...
# 🥗  N2026063012483863   McCain Curly Fries (Spicy)
