...
aliases:
  ...
  - "Gambas peladas"
  - "K-Classic Party-Garnelen (gekocht & geschält)"
  - "Party Shrimps"
  - "Party-Garnelen"
  - "Penaeus monodon (Frozen)"
  - "Креветки очищенные"
  - "むきえび"
  - "روبيان مقشر"
  - "میگو پوست‌کنده"
...
sci: 
  - "#sci/MarineBiology"
latin: "Penaeus monodon (Frozen)"
en: "Party Shrimps"
hi: "झींगा"
unit_price: 6.00
props: 
  - "Extrem fettarmer Protein-Booster"
  - "Die 'Eisglasur' verhindert Gefrierbrand und schützt das Aroma"
  - "Ideal für Salate oder schnelle Pasta-Saucen"
label: "K-Classic Party-Garnelen (gekocht & geschält)"
ru: "Креветки очищенные"
certification: "ASC (Sustainable Farming)"
brand: "K-Classic"--
arch:
  - "#5note"
archtype:
...
# 🥗  N2026063012483892   K-Classic Party-Garnelen (gekocht & geschält)
