...
tags:
  - "#entity/ingredient"
aliases:
  - "Brassica oleracea var. capitata f. rubra (Herba recens)"
  - "Chou rouge"
  - "Lombarda"
  - "Red Cabbage"
  - "Rotkohl, Blaukraut"
...
kaufland: 1
vit_k_mcg: 38.0
latin: "Brassica oleracea var. capitata f. rubra (Herba recens)"
es: "Lombarda"
ar: "كرنب أحمر"
icon: "🟣"
potassium_mg: 243.0
...
vegan: true
kcal: 31
antioxidant_focus: "Anthocyanin power"
lidl: 1
fr: "Chou rouge"
sci: 
  - "#sci/Phytochemistry"
en: "Red Cabbage"
hi: "लाल पत्ता गोभी"
anthocyanins_mg: 190.0
props: 
  - "Massive antioxidant load"
  - "Natural pH indicator (color changes)"
  - "Excellent for fermentation (Blaukraut)"
denns: 1
label: "Red Cabbage"
ru: "Красная капуста"
de: "Rotkohl, Blaukraut"
vit_c_mg: 57.0
rewe: 1--
arch:
  - "#5note"
