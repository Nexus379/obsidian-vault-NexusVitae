...
aliases:
  - "Daikon"
  - "Daikon Radish"
  - "Daikon-Rettich, Weißer Rettich"
  - "Nabo daikon"
  - "Radis blanc"
  - "Raphanus sativus var. longipinnatus (Radix recens)"
  - "Дайкон"
  - "ترب سفید"
  - "فجل أبيض"
  - "सफेद मूली"
...
season: 
  - "all_year"
asia_market: 2.00
latin: "Raphanus sativus var. longipinnatus (Radix recens)"
es: "Nabo daikon"
ar: "فجل أبيض"
unit_type: "piece"
icon: "🥢"
...
props: 
  - "Huge white root"
  - "Helps digest heavy starches"
  - "Mildest of all radishes"
denns: 2.00
label: "Daikon Radish"
ru: "Дайкон"
...
# 🥗  N2026063012482340   Daikon Radish
