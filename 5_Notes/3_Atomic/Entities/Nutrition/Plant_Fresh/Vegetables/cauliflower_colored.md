...
note5:
nextstudy:
LID: "N2026063012482448"
parent: ""
tags:
  - "#entity/ingredient"
aliases:
  - "Brassica oleracea var. botrytis (Inflorescentia colorata)"
  - "Bunter Blumenkohl (Lila/Orange)"
  - "Chou-fleur coloré"
  - "Coliflor de colores"
  - "Colored Cauliflower"
  - "Purple/Orange Cauliflower"
  - "Цветная цветная капуста"
  - "カラフルカリフラワー"
  - "قرنبيط ملون"
  - "گل کلم رنگی"
  - "रंगीन फूलगोभी"
...
season: 
  - "autumn"
weekly_market: 1
latin: "Brassica oleracea var. botrytis (Inflorescentia colorata)"
es: "Coliflor de colores"
ar: "قرنبيط ملون"
icon: "🟣"
vit_c_mg: 50.0
ja: "カラフルカリフラワー"
vegan: true
visual: "Vibrant purple or orange"
kcal: 25
fr: "Chou-fleur coloré"
sci: 
  - "#sci/Phytochemistry"
en: "Colored Cauliflower"
beta_carotene_mcg: 300.0
denns: 1
hi: "रंगीन फूलगोभी"
anthocyanins_mg: 45.0
props: 
  - "Orange contains 25x more Vit A than white"
  - "Purple contains red wine-type antioxidants"
  - "Maintains color during light steaming"
label: "Purple/Orange Cauliflower"
ru: "Цветная цветная капуста"
de: "Bunter Blumenkohl (Lila/Orange)"--
arch:
  - "#5note"
archtype:
  - "#5note/3atomic/nutrition"
...
# 🥗  N2026063012482448   Purple/Orange Cauliflower
