...
note5:
nextstudy:
LID: "N2026063012482063"
parent: ""
tags:
  - "#entity/ingredient"
aliases:
  - "Sesamum indicum paste"
  - "Tahini (Dark)"
  - "Tahini (Dark/Unhulled)"
  - "Tahini (Dunkel/Ungeschält)"
  - "Tahini complet"
  - "Tahini oscuro"
  - "Тахини (тёмная)"
  - "ارده تیره"
...
reformhaus: 6.00
unit_price: 6.00
benefit: "Massive Plant Calcium"
props: 
  - "Made from whole, unhulled sesame seeds"
  - "More than double the calcium of white tahini"
  - "Stronger, earthier, and slightly more bitter flavor"
orient_market: 6.00
process: "Unhulled seeds"
label: "Tahini (Dark/Unhulled)"
ru: "Тахини (тёмная)"
denns: 6.00--
arch:
  - "#5note"
...
# 🥗  N2026063012482063   Tahini (Dark/Unhulled)
