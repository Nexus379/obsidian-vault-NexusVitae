...
note5:
nextstudy:
LID: "N2026063012481844"
parent: ""
tags:
  - "#entity/ingredient"
aliases:
  - "Gluten-Free Pasta (Corn/Rice)"
  - "Glutenfreie Pasta (Mais/Reis)"
  - "Glutenfreie Pasta (Mais-Reis-Mischung)"
  - "Pasta sin gluten (Maíz/Arroz)"
  - "Pâtes sans gluten (Maïs/Riz)"
  - "Zea mays et Oryza sativa (Fila)"
  - "Безглютеновые макароны (Кукуруза/Рис)"
  - "グルテンフリーパスタ (コーン/米)"
  - "پاستا بدون گلوتن (ذرت/برنج)"
  - "مكرونة خالية من الجلوتين (ذرة/أرز)"
  - "ग्लूटेन-फ्री पास्ता (मक्का/चावल)"
  - "无麸质意面 (玉米/大米)"
priority: 
subject: "Nutrition"
persona: "alchemist"
...
# locations: 
  ...
  - "dm"
  - "rewe"
fa: "پاستا بدون گلوتن (ذرت/برنج)"
protein_g: 7.0
zh: "无麸质意面 (玉米/大米)"
season: 
  - "all_year"
sugar_g: 0.5
de: "Glutenfreie Pasta (Mais/Reis)"
fiber_g: 1.5
es: "Pasta sin gluten (Maíz/Arroz)"
ar: "مكرونة خالية من الجلوتين (ذرة/أرز)"
unit_type: "piece"
icon: "🌽"
ja: "グルテンフリーパスタ (コーン/米)"
vegan: true
...
fat_total_g: 1.5
kaufland: 3.00
texture: "Often lacks stretch"
fr: "Pâtes sans gluten (Maïs/Riz)"
water_g: 10.0
sci: 
  - "#sci/FoodScience"
  - "#sci/Rheology"
usage: "1:1 Wheat pasta replacement"
carbs_total_g: 78.0
latin: "Zea mays et Oryza sativa (Fila)"
en: "Gluten-Free Pasta (Corn/Rice)"
hi: "ग्लूटेन-फ्री पास्ता (मक्का/चावल)"
unit_price: 3.00
props: 
  - "Die Standard-Alternative für Zöliakie-Patienten im Supermarkt (z.B. Barilla Senza Glutine)"
  - "Oft eine Mischung aus Mais- und Reismehl (manchmal mit Emulgatoren zur Formstabilität)"
  - "Wird beim Abkühlen oft sehr hart oder klebrig"
label: "Glutenfreie Pasta (Mais-Reis-Mischung)"
ru: "Безглютеновые макароны (Кукуруза/Рис)"
dm: 3.00
lidl: 3.00
rewe: 3.00--
arch:
...
# 🥗  N2026063012481844   Glutenfreie Pasta (Mais-Reis-Mischung)
