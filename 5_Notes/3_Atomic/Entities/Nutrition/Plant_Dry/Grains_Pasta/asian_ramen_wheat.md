...
water_g: 10.0
props: 
  - "Spezielle Weizennudeln, die durch alkalisches Wasser (Kansui) ihre gelbe Farbe und elastische Textur erhalten"
  - "Halten auch in heißer Brühe lange ihren Biss"
  - "Basis für alle japanischen Ramen-Suppen"
fiber_g: 2.0
springiness: "High elastic recovery"
fat_total_g: 1.0
icon: "🍜"
sugar_g: 1.0
en: "Ramen Noodles"
...
locations: 
  ...
  - "rewe"
  - "kaufland"
alkalinity: "Kansui (Alkaline mineral water)"--
arch:
  - "#5note"
archtype:
  - "#5note/3atomic/nutrition"
...
# 🥗  N2026063012481817   Ramen Nudeln (Weizen)
