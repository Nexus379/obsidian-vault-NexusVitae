...
aliases:
  ...
  - "Farfalle / Lacitos"
  - "Farfalle / Schmetterlingsnudeln"
  - "Triticum durum (Papiliones)"
  - "Фарфалле (Бабочки)"
  - "ファルファッレ"
  - "پاستا پروانه‌ای"
  - "فارفالي (مكرونة فراشة)"
  - "फरफले (बटरफ्लाई पास्ता)"
  - "蝴蝶面"
priority: 
subject: "Nutrition"
persona: "alchemist"
...
season: 
  - "all_year"
sugar_g: 2.5
de: "Farfalle / Schmetterlingsnudeln"
fiber_g: 3.0
es: "Farfalle / Lacitos"
ar: "فارفالي (مكرونة فراشة)"
unit_type: "piece"
icon: "🦋"
ja: "ファルファッレ"
vegan: true
...
fat_total_g: 1.5
kaufland: 2.00
texture: "Varying thickness"
fr: "Farfalle"
water_g: 11.0
sci: 
  - "#sci/Geometry"
  - "#sci/FoodScience"
usage: "Cold salads & Cream sauces"
carbs_total_g: 72.0
latin: "Triticum durum (Papiliones)"
en: "Farfalle / Bow-tie Pasta"
hi: "फरफले (बटरफ्लाई पास्ता)"
unit_price: 2.00
props: 
  - "In der Mitte dicker geklemmt, an den Rändern dünn, was für zwei unterschiedliche Garstufen (Bissfestigkeiten) in einer Nudel sorgt"
  - "Klassiker für kalte Nudelsalate, da sie optisch extrem ansprechend bleiben"
  - "Fangen durch die Klemmung dicke Saucen gut ein"
label: "Farfalle (Schmetterlingsnudeln)"
ru: "Фарфалле (Бабочки)"
lidl: 2.00
rewe: 2.00--
arch:
...
# 🥗  N2026063012481871   Farfalle (Schmetterlingsnudeln)
