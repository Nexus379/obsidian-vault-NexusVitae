...
aliases:
  - "Oryza sativa (Fila)"
  - "Reisnudeln"
  - "Reisnudeln (Bandschnitt/Vermicelli)"
  - "Rice Noodles"
  - "米粉"
  - "米粉麺"
priority: 
...
sci: 
  ...
  - "#sci/GlutenFree"
carbs_total_g: 80.0
latin: "Oryza sativa (Fila)"
en: "Rice Noodles"
props: 
  - "Bestehen nur aus Reismehl und Wasser"
  - "Absolut fettarm und leicht verdaulich"
  - "Basis für Pad Thai oder Pho Suppen"
label: "Reisnudeln (Bandschnitt/Vermicelli)"
lidl: 1
rewe: 1--
arch:
  - "#5note"
...
# 🥗  N2026063012481817   Reisnudeln (Bandschnitt/Vermicelli)
