...
note5:
nextstudy:
LID: "N2026063012481711"
parent: ""
tags:
  - "#entity/ingredient"
aliases:
  - "Cream of Tartar Baking Powder (GF)"
  - "Levadura en polvo sin gluten"
  - "Poudre à lever sans gluten"
  - "Pulvis fermentans (Potassii bitartras)"
  - "Weinstein-Backpulver (GF)"
  - "Weinstein-Backpulver (Glutenfrei)"
  - "Безглютеновый разрыхлитель"
  - "ベーキングパウダー (グルテンフリー)"
  - "بکینگ پودر بدون گلوتن"
  - "مسحوق خبز خالي من الجلوتين"
  - "ग्लूटेन-फ्री बेकिंग पाउडर"
  - "无麸质发酵粉"
priority: 
subject: "Nutrition"
persona: "alchemist"
...
locations: 
  ...
  - "rewe"
  - "alnatura"
fa: "بکینگ پودر بدون گلوتن"
protein_g: 0.1
zh: "无麸质发酵粉"
sugar_g: 0.0
de: "Weinstein-Backpulver (GF)"
fiber_g: 0.0
es: "Levadura en polvo sin gluten"
ar: "مسحوق خبز خالي من الجلوتين"
unit_type: "piece"
icon: "🧁"
ja: "ベーキングパウダー (グルテンフリー)"
vegan: true
kcal: 235
starch_base: "Corn or Tapioca Starch (GF)"
fr: "Poudre à lever sans gluten"
water_g: 2.0
sci: 
  - "#sci/FoodScience"
  - "#sci/Chemistry"
carbs_total_g: 44.0
latin: "Pulvis fermentans (Potassii bitartras)"
...
props: 
  ...
  - "Uses gluten-free starch as a separating agent"
denns: 2.00
label: "Weinstein-Backpulver (Glutenfrei)"
gluten_free: true
...
# 🥗  N2026063012481711   Weinstein-Backpulver (Glutenfrei)
