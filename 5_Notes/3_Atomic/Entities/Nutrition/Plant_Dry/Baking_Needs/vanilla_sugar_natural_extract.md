...
note5:
nextstudy:
LID: "N2026063012481721"
parent: ""
tags:
  - "#entity/ingredient"
aliases:
  - "Azúcar con extracto de vainilla"
  - "Saccharum vanillatum (Extractum)"
  - "Sucre à l'extrait de vanille"
  - "Vanilla Extract Sugar"
  - "Vanillezucker (Natürlicher Extrakt)"
  - "Vanillezucker (Natürliches Aroma)"
  - "Сахар с экстрактом ванили"
  - "バニラエキストラクトシュガー"
  - "سكر بخلاصة الفانيليا"
  - "شکر عصاره وانیل"
  - "वेनिला अर्क चीनी"
  - "香草提取物糖"
priority: 
...
fa: "شکر عصاره وانیل"
protein_g: 0.0
distinction: "No synthetic additives, but no pod pieces required"
zh: "香草提取物糖"
sugar_g: 99.0
de: "Vanillezucker (Natürliches Aroma)"
fiber_g: 0.0
es: "Azúcar con extracto de vainilla"
ar: "سكر بخلاصة الفانيليا"
unit_type: "piece"
icon: "🍯"
ja: "バニラエキストラクトシュガー"
vegan: true
...
fat_total_g: 0.0
kaufland: 2.00
fr: "Sucre à l'extrait de vanille"
water_g: 0.2
source: "Real vanilla extract"
sci: 
  - "#sci/FoodScience"
  - "#sci/Phytochemistry"
carbs_total_g: 99.0
edeka: 2.00
latin: "Saccharum vanillatum (Extractum)"
en: "Vanilla Extract Sugar"
hi: "वेनिला अर्क चीनी"
unit_price: 2.00
props: 
  - "Legally must contain flavoring extracted directly from real vanilla pods"
  - "Does not have to be from the 'Bourbon' region"
  - "Aromatic but visually clean (no black specks)"
label: "Vanillezucker (Natürlicher Extrakt)"
ru: "Сахар с экстрактом ванили"
rewe: 2.00--
arch:
  - "#5note"
archtype:
...
# 🥗  N2026063012481721   Vanillezucker (Natürlicher Extrakt)
