...
aliases:
  ...
  - "Harina de almendra desgrasada"
  - "Mandelmehl (Entölt)"
  - "Prunus dulcis (Semen deoleatum pulvis)"
  - "Миндальная мука (обезжиренная)"
  - "アーモンドプードル (脱脂)"
  - "آرد بادام"
  - "دقيق اللوز منزوع الدسم"
  - "बादाम का आटा"
  - "脱脂杏仁粉"
priority: 
subject: "Nutrition"
...
season: 
  - "all_year"
latin: "Prunus dulcis (Semen deoleatum pulvis)"
fiber_g: 16.0
es: "Harina de almendra desgrasada"
ar: "دقيق اللوز منزوع الدسم"
unit_type: "piece"
icon: "🌰"
ja: "アーモンドプードル (脱脂)"
vegan: true
...
fat_total_g: 11.0
carbs_g: 7.0
fr: "Farine d'amande déshuilée"
macro_focus: "Ultra High Protein / Low Carb"
sci: 
  - "#sci/Nutrition"
  - "#sci/Keto"
rossmann: 10.00
en: "Defatted Almond Flour"
hi: "बादाम का आटा"
unit_price: 10.00
props: 
  - "Oil is pressed out"
  - "Absorbs huge amounts of liquid"
  - "Staple in Keto and Low-Carb baking"
denns: 10.00
label: "Almond Flour (Defatted)"
ru: "Миндальная мука (обезжиренная)"
de: "Mandelmehl (Entölt)"
dm: 10.00--
arch:
  - "#5note"
archtype:
...
# 🥗  N2026063012481681   Almond Flour (Defatted)
