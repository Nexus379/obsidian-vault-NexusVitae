...
note5:
nextstudy:
LID: "N2026063012483114"
parent: ""
tags:
  - "#entity/ingredient"
aliases:
  - "Innocent Naranja con Pulpa"
  - "Innocent Orange (mit Fruchtfleisch)"
  - "Innocent Orange (Mit viel Fruchtfleisch)"
  - "Innocent Orange avec Pulpe"
  - "Innocent Orange with Pulp"
  - "Innocent 带果肉橙汁"
  - "Succus aurantii directus (Innocent)"
  - "Инносент Апельсин с мякотью"
  - "イノセント オレンジ 果肉入り"
  - "آب پرتقال پالپ‌دار اینوسنت"
  - "إينوسينت برتقال مع اللب"
  - "इनोसेंट ऑरेंज पल्प के साथ"
priority: 
subject: "Nutrition"
persona: "alchemist"
status: 1active
...
# locations: 
  ...
  - "edeka"
  - "kaufland"
fa: "آب پرتقال پالپ‌دار اینوسنت"
protein_g: 0.7
zh: "Innocent 带果肉橙汁"
sugar_g: 7.4
de: "Innocent Orange (mit Fruchtfleisch)"
fiber_g: 0.8
es: "Innocent Naranja con Pulpa"
ar: "إينوسينت برتقال مع اللب"
unit_type: "piece"
icon: "🍊"
vit_c_mg: 28.0
ja: "イノセント オレンジ 果肉入り"
...
fat_total_g: 0.2
kaufland: 4.00
fr: "Innocent Orange avec Pulpe"
water_g: 91.0
storage: "Chilled only (2-8°C)"
sci: 
  - "#sci/Nutrition"
  - "#sci/FoodScience"
carbs_total_g: 7.4
...
props: 
  ...
  - "Tastes closest to freshly squeezed homemade juice"
process: "Cold-pressed / Never from concentrate"
...
# 🥗  N2026063012483114   Innocent Orange (Mit viel Fruchtfleisch)
