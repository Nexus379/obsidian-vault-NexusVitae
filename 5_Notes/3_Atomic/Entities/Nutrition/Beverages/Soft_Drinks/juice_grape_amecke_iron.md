...
aliases:
  - "Amecke Grape + Iron"
  - "Amecke Raisin + Fer"
  - "Amecke Rote Traube + Eisen"
  - "Amecke Traube + Eisen"
  - "Amecke Uva + Hierro"
  - "Amecke 葡萄+铁"
  - "Succus vitis rubrae (Amecke + Ferrum)"
  - "Амеке Виноград + Железо"
  - "アメッケ グレープ＋鉄分"
  - "آمکه انگور و آهن"
  - "أميكه عنب + حديد"
  - "अमेके ग्रेप + आयरन"
...
zh: "Amecke 葡萄+铁"
sugar_g: 15.6
de: "Amecke Traube + Eisen"
fiber_g: 0.1
es: "Amecke Uva + Hierro"
ar: "أميكه عنب + حديد"
unit_type: "piece"
icon: "🍇"
vit_c_mg: 12.0
...
carbs_total_g: 15.6
edeka: 3.00
latin: "Succus vitis rubrae (Amecke + Ferrum)"
en: "Amecke Grape + Iron"
hi: "अमेके ग्रेप + आयरन"
unit_price: 3.00
benefit: "Bioavailable Iron (Iron(II) + Vit C synergy)"
props: 
  - "Functional juice heavily fortified with iron"
  - "Contains added Vitamin C to boost iron absorption"
  - "Very sweet, deep red grape base"
label: "Amecke Rote Traube + Eisen"
ru: "Амеке Виноград + Железо"
fortification: "High"--
arch:
  - "#5note"
archtype:
...
# 🥗  N2026063012483117   Amecke Rote Traube + Eisen
