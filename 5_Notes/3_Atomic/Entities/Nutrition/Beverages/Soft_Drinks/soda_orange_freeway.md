...
aliases:
  ...
  - "Freeway Orange (Lidl)"
  - "Freeway 橙味"
  - "Potio carbonata (Freeway Aurantium)"
  - "Фривей Апельсин"
  - "フリーウェイ オレンジ"
  - "فري واي برتقال"
  - "فری‌وی پرتقالی"
...
sci: 
  ...
  - "#sci/Nutrition"
carbs_total_g: 9.8
latin: "Potio carbonata (Freeway Aurantium)"
en: "Freeway Orange"
hi: "फ्रीवे ऑरेंज"
unit_price: 1.00
props: 
  - "Lidl's budget alternative to Fanta"
  - "Full sugar profile (no artificial sweeteners in the classic version)"
  - "Intense bright orange color"
label: "Freeway Orange (Lidl)"
ru: "Фривей Апельсин"
sweetener: "100% Sugar"
lidl: 1.00--
arch:
...
# 🥗  N2026063012483089   Freeway Orange (Lidl)
