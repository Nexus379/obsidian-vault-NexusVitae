...
aliases:
  - "K-Classic Mate"
  - "K-Classic Mate (Kaufland)"
  - "K-Classic Мате"
  - "K-Classic マテ"
  - "K-Classic 玛黛茶"
  - "Mate K-Classic"
  - "Maté K-Classic"
  - "Potio carbonata (K-Classic Ilex)"
  - "ك-كلاسيك ماتي"
  - "ماته کا-کلاسیک"
  - "के-क्लासिक मेट"
priority: 
...
zh: "K-Classic 玛黛茶"
sugar_g: 5.2
latin: "Potio carbonata (K-Classic Ilex)"
fiber_g: 0.0
es: "Mate K-Classic"
ar: "ك-كلاسيك ماتي"
unit_type: "piece"
...
unit_price: 1.00
props: 
  - "Kaufland's budget clone of the classic mate profile"
  - "Priced significantly lower than the branded glass bottles"
  - "Sold in PET bottles for convenience"
label: "K-Classic Mate (Kaufland)"
ru: "K-Classic Мате"
de: "K-Classic Mate"
hi: "के-क्लासिक मेट"--
arch:
...
# 🥗  N2026063012483246   K-Classic Mate (Kaufland)
