...
note5:
nextstudy:
LID: "N2026063012483153"
parent: ""
tags:
  - "#entity/ingredient"
aliases:
  - "Fructus tritus viridis (Kauflandia)"
  - "K-to-go Apple Mint Smoothie"
  - "K-to-go Smoothie Apfel-Minze"
  - "K-to-go Smoothie Apfel-Minze (Kaufland)"
  - "K-to-go Яблоко-мята смузи"
  - "K-to-go アップル・ミント"
  - "K-to-go 苹果薄荷冰沙"
  - "Smoothie manzana menta K-to-go"
  - "Smoothie pomme menthe K-to-go"
  - "اسموتی سیب و نعنا کا-تو-گو"
  - "عصير ك-تو-جو تفاح ونعناع"
  - "के-टू-गो एप्पल मिंट स्मूदी"
priority: 
subject: "Nutrition"
persona: "alchemist"
status: 1active
...
locations: 
  - "kaufland"
fa: "اسموتی سیب و نعنا کا-تو-گو"
protein_g: 0.4
zh: "K-to-go 苹果薄荷冰沙"
sugar_g: 9.4
de: "K-to-go Smoothie Apfel-Minze"
fiber_g: 1.1
es: "Smoothie manzana menta K-to-go"
ar: "عصير ك-تو-جو تفاح ونعناع"
unit_type: "piece"
icon: "🍏"
ja: "K-to-go アップル・ミント"
vegan: true
...
kaufland: 2.00
packaging: "PET"
fr: "Smoothie pomme menthe K-to-go"
water_g: 87.5
sci: 
  - "#sci/Culinary"
  - "#sci/Phytochemistry"
...
# 🥗  N2026063012483153   K-to-go Smoothie Apfel-Minze (Kaufland)
